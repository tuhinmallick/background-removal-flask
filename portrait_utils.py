...
def load_model():
    model_dir = './saved_models/u2net_portrait.pth'
    net = U2NET(3, 1)
...
def inference(net,input):
    ...
    return pred
def process_portrait_image(input_img):
    """
    ...
    face = detect_single_face(face_cascade, input_img)
    im_face = crop_face(input_img, face)
